          ...
          <table border="0" width="100%">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                ...
                <input class="form-control" type="text" maxlength="14" id="cpf" onkeydown="javascript: fMasc( this, mCPF );"
                  placeholder="CPF" />
                <p id="idCPF"> </p>
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                ...
                <input class="form-control" type="text" maxlength="14" id="telefone" onkeydown="javascript: fMasc( this, mTel );"
