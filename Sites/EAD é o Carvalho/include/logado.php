<div class="container">
  ...
  <div class="box">
    ...
    ?>
    <a class="btn btn-info btn-lg btn-block glyphicon glyphicon-menu-right" style="text-align:left;" data-toggle="collapse"
      href="#Materia<?php print($cont_materia); ?>" role="button" aria-expanded="false" aria-controls="Materia<?php print($cont_materia); ?>">
      ...
      <div class="card card-body">
        <?php
          ...
          foreach($todas_aulas as $aula) :
            // echo $aula["data_aula"];
        ?>
        <a class="btn btn-secondary" data-toggle="collapse" href="#Aula<?php print($aula[" id"]); ?>" role="button"
          aria-expanded="false" aria-controls="Aula
          <?php print($aula["id"]); ?>">
          <?php
        ...
        <div class="collapse" id="Aula<?php  print($aula[" id"]); ?>">
          <div class="card card-body">
            <div>
              <h5>Sua aula é no dia
                <?php echo $aula["data_aula"]; ?>
              </h5>
              <h4>Descrição da Aula:</h4>
              <h5>
                <?php print($aula["descricao"]);?>
              </h5>
              <?php
                if($aula["link_video"] != ""){
              ?>
            ...
            <div>
              <?php
                if ($aula["arquivo"] != 0){
              ?>
              <a class="btn" href="arquivos_aula/<?php echo ($aula[" arquivo"]);?>"
                target="_blank"
                style="
                float: right;
                width: 150px;
